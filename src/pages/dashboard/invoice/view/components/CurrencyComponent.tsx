...
export default function CurrencyComponent({ amount, currency, withoutCurrency }: { amount: number, currency: string | undefined, withoutCurrency?: boolean }) {
    ...
    return (
        ...
        <span className="text-sm color-muted-foreground">
            .{post}
        </span>
        </div>
    );

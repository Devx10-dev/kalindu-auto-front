        ...
        <div className="flex items-center gap-2">
          <Avatar className="hidden h-9 w-9 sm:flex">
              ...
              // seperate by space and add + sign to join
                src={"https://avatar.iran.liara.run/username?username="+creditorDetails.shopName.split(" ").join("+")}
                alt="Avatar"
              />
              {/* <AvatarFallback>
          ...
          <div className="grid gap-1">
              ...
              <p className="text-sm text-muted-foreground">{creditorDetails?.primaryContact}</p>
          </div>
        </div>
        <div className="flex flex-col gap-1 items-end">
          <div className="ml-auto font-medium">Rs. {creditorDetails?.totalDue}</div>
          <div className="flex gap-1">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex gap-1 items-center"> 
                    ...
                    <Badge className="w-fit" variant="secondary" >{creditorDetails?.overdueInvoiceCount}</Badge>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex gap-1 items-center">
                    ...
                    <Badge className="w-fit" variant="secondary" > {creditorDetails?.dueInvoiceCount}</Badge>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
            ...
            <Badge className="w-fit" variant="destructive" > {creditorDetails?.daysOverdueOrDueDays} days</Badge>
          </div>
        </div>
      </div>
  </div>

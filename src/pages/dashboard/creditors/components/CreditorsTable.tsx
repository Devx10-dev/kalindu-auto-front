...
import { ArrowLeftRight, BadgeInfo, CircleHelp, Info, Pencil, TimerOff, TimerReset, UserRoundCog } from "lucide-react";
...
const CreditorsTable = (props: { creditorData?: Creditor[], isLoading?: boolean }) => {

...
import InvoiceTransactionTimeLine from "./InvoiceTransactionTimeline";
import CashInvoiceTransactionTimeLine from "./CashInvoiceTransactionTimeline";

export function CashInvoiceTransactionDrawer({
  nonIcon = false,
  invoiceId,
  creditorName,
}: {
  ...
  const {
    ...
    queryFn: () =>
      transactionService.getCashInvoiceTransactions(
        invoiceId,
        pageNo,
        pageSize,
        selectedOption,
    ...
    <Drawer direction="right">
      ...
      <DrawerContent className="h-screen top-0 right-0 left-auto mt-0 w-[500px] rounded-none flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto px-10 py-4">
          <CashInvoiceTransactionTimeLine
            invoiceId={invoiceId}
